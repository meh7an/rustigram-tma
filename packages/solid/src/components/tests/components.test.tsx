...
describe("BackButton", () => {
  it("shows on mount and hides on unmount", () => {
    ...
    const { unmount } = render(
      () => <Wrapper><BackButton onBack={() => {}} /></Wrapper>,
    );
  ...
  it("fires onBack when backButtonClicked is emitted", () => {
    ...
    const Wrapper = wrapper(mock);
    const handler = vi.fn();
    render(() => <Wrapper><BackButton onBack={handler} /></Wrapper>);
...
describe("MainButton", () => {
  it("shows on mount and hides on unmount", () => {
    ...
    const Wrapper = wrapper(mock);
    const { unmount } = render(
      () => <Wrapper><MainButton text="Pay" onClick={() => {}} /></Wrapper>,
    );
  ...
  it("sets the button text reactively", () => {
    const mock = createTmaMock();
    const Wrapper = wrapper(mock);
    render(() => <Wrapper><MainButton text="Confirm" onClick={() => {}} /></Wrapper>);
  ...
  it("fires onClick when mainButtonClicked is emitted", () => {
    ...
    const Wrapper = wrapper(mock);
    const handler = vi.fn();
    render(() => <Wrapper><MainButton onClick={handler} /></Wrapper>);
